...
from . views import appadmin, appadminhome, \
    ...
    studentlogin, studenthome, reviewevaluation, registerprofessor, logout_appadmin, logout_professor, logout_student
...
urlpatterns = [
    ...
    path('reviewevaluation', reviewevaluation, name='reviewevaluation'),
